...
<div id="header">	
	<div id="headerContent">
		<div class="hgroup" style="display: none;">
			<h1 class="logo"><a href="mainIndex.bo">
			<img src="images/common/img_logo01.png" alt="AIR SEOUL"></a></h1>
			<div class="hrgroup" id="flagLogin">
				<span class="login" id="loginSpan">
					<a href="I/ko/viewTwoLoginPnr2" style="cursor:pointer;" id="I/ko/viewTwoLoginPnr2" class="jsOpenLayer">로그인</a>
				</span>
		...
		<div id="smallHeader" style="top: 0px;">
...
<div id="gnb" class="js-gnb" style="display: none;">
 	<ul class="depth01">
...
var _kName = '';			// 한글 성명(내국인만 해당)
var _eName = '';		// 영어 성명(내외국인 전체)
var _userId = '';			// 유저 아이디
var _userEmail = '';		// 유저 이메일
var _isLogin = false;			// 로그인 여부.(true : 로그인 상태, false : 로그아웃 상태)
var _isMember = false;			// 회원 여부.(true : 회원 상태, false : 비회원 상태)
var _couponCnt = '';	// 로그인 했을경우 보유쿠폰수(없을시 공백)
var _birthDay = '';		// 생년월일(YYYYMMDD)
...
</script><script src="https://cr.acecounter.com/Web/AceCounter_AW.js?gc=AH3A40721367092&amp;py=0&amp;gd=gtp13&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1499645239823" type="text/javascript"></script>
