...
<div class="space"></div>
	...
	<div id="form">
		<div class="check">
			<h3>약관 동의</h3>
			<div class="ch_1">
				<textarea rows="20" cols="100">힝</textarea>
			</div>
		</div>		
		<div class="space"></div>
		<div>
			<form method="post" id="joinForm" name="joinForm">
				<table>
					...
					<tr>
						<td>GENDER</td>
						<td><input type="radio" id="gender" name="gender" value="female">여성
							<input type="radio" id="gender" name="gender" value="male">남성
						</td>
					</tr>
					<tr>
						<td>BIRTH</td>
						<td><input type="text" id="birth" name="birth" placeholder="19940131 과 같이"></td>
					</tr>
					<tr>
						<td>E-MAIL</td>
